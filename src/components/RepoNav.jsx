    ...
    <div>
      <ul className="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
        ...
        <li className="font-semibold">
          <a
            href="#"
            className="flex items-center border-b-2 border-transparent transition ease-in-out duration- 150 hover:border-gray-400 border-red-500 px-4 pb-3"
          >
            <svg
              aria-hidden="true"
              height="16"
            ...
            <div className="text-xs rounded-lg bg-gray-700 px-2 ml-1">160</div>
          </a>
        </li>
        <li className="font-semibold">
          <a
          ...
          >
            ...
            <div className="text-xs rounded-lg bg-gray-700 px-2 ml-1">106</div>
          </a>
        </li>
        <li className="font-semibold">
          <a
...
<a
  href="#"
  className="flex items-center border-b-2 border-transparent transition ease-in-out duration- 150 hover:border-gray-400 px-4 pb-3"
>
  <svg
    aria-hidden="true"
    height="16"
